...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-2f498f7081e42f2e"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-2f498f7081e42f2e",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-2f498f7081e42f2e",
        "url": "https://en.wikipedia.org/wiki/Beal%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Beal's conjecture : for all integral solutions to $A^{x}+B^{y}=C^{z}$ where $x,y,z>2$ , all three numbers $A,B,C$ must share some prime factor.",
      "version": 1
    },
    "title": "Beal's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "7d56f0cded174ee2c039eae75c2863089eacef7b9c2add790745b88a109d70a9"
}
```
